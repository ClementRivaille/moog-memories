...
*/
class Orchestra {
  constructor(soundsConfig, context) {
    this.context = context;
    this.sounds = {};

    this.loader = new BufferLoader(context, soundsConfig);

    for (let sound of soundsConfig) {
      this.sounds[sound.name] = Object.assign({playing: false}, sound);
    }
  }
